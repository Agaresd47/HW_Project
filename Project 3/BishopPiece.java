/**
 * An  class that encodes specific rules for bishop pieces.
 *
 * @author Bruce Dong
 */
public class BishopPiece  extends ChessPiece{
   ...
   */
  public BishopPiece ( ChessGame.Side side, int row, int col, String label,ChessBoard board){
  ...
  public boolean isLegalMove(int toRow, int toColumn){
    return isLegalMoveDiagnoal(toRow, toColumn);
  }
}