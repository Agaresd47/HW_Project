...
public class EuropeanChessTester {
  ...
  public void testRook() {
    EuropeanChess EC = new EuropeanChess();
    SwingEuropeanChessDisplay ECD = new SwingEuropeanChessDisplay();
    ChessBoard CP = new SwingChessBoard( 9,8, ECD, EC);
  ...
  public void testBishopQueen() {
    EuropeanChess EC = new EuropeanChess();
    SwingEuropeanChessDisplay ECD = new SwingEuropeanChessDisplay();
    ChessBoard CP = new SwingChessBoard( 9,9, ECD, EC);
    // Add all the friendly piece into the board
  ...
  public void testKnightKing() {
    EuropeanChess EC = new EuropeanChess();
    SwingEuropeanChessDisplay ECD = new SwingEuropeanChessDisplay();
    SwingChessBoard CP = new SwingChessBoard( 9,5, ECD, EC);
    // Knight Part
  ...
  public void testCastleMove() {
    EuropeanChess EC = new EuropeanChess();
    SwingEuropeanChessDisplay ECD = new SwingEuropeanChessDisplay();
    SwingChessBoard CP = new SwingChessBoard( 8,8, ECD, EC);
  ...
  public void testPawn() {
    EuropeanChess EC = new EuropeanChess();
    SwingEuropeanChessDisplay ECD = new SwingEuropeanChessDisplay();
    SwingChessBoard CP = new SwingChessBoard( 8,7, ECD, EC);
